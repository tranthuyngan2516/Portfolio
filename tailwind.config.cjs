...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // --- ĐÃ SỬA MÀU Ở ĐÂY ---
        primary: '#000000', // Đổi từ xanh đen sang ĐEN TUYỀN
        secondary: '#aaa6c3',
        tertiary: '#000000', // Đổi từ tím than sang ĐEN (để thẻ Project hòa vào nền)
        'black-100': '#1a1a1a', // Đổi sang xám đen trung tính
        'black-200': '#0f0f0f', // Đổi sang xám đen trung tính
        // ------------------------
