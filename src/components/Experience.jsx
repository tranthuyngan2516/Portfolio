...
const ExperienceCard = ({ experience, lang }) => (
  <VerticalTimelineElement
    ...
    date={
      <div>
        <h3 className="text-dim text-[18px] font-bold font-montserrat">
    ...
    <div>
      <h3 className="text-jetLight text-[24px] font-bold font-montserrat tracking-[2px]">
        {experience[lang].title}
      </h3>
      <p
        className="text-taupe text-[22px] font-semibold font-montserrat tracking-[1px]"
        style={{ margin: 0 }}>
        ...
        <VerticalTimeline className="vertical-timeline-custom-line">
          ...
          <VerticalTimelineElement
            ...
            <button
              ...
              font-bold font-montserrat items-center py-5 pl-3 pr-3 
